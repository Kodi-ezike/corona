...
document.querySelector('#cases').addEventListener("click",function() {
  ...
  //this is for when a user inputs something that is not a country
    if(!Array.isArray(data)){
      document.getElementById("results").innerHTML = "Country does not exist or country has no case of corona virus";
